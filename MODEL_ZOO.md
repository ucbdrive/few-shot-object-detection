...
You can access the models from code using the detectron2.model_zoo API (official documentation [here](https://detectron2.readthedocs.io/modules/model_zoo.html)).
